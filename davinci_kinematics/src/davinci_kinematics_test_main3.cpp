  ...
  //}
    ...
    */    
    // use published values:
        //q_vec = g_q_vec;
    cout<<"enter q vals: q0 = ";
    cin>>q_vec(0);
    cout<<"enter q vals: q1 = ";
    cin>>q_vec(1);
    cout<<"enter q vals: q2 = ";
    cin>>q_vec(2);
    cout<<"enter q vals: q3 = ";
    cin>>q_vec(3);
    cout<<"enter q vals: q4 = ";
    cin>>q_vec(4);    
    cout<<"enter q vals: q5 = ";
    cin>>q_vec(5);
...
*/
   ...
   Eigen::Vector3d z_vec4,alt_O4;
   //compute_w_from_tip(Eigen::Affine3d affine_gripper_tip, Eigen::Vector3d &zvec_4,
   //     Eigen::Vector3d &alt_O4);
   w_wrt_base = ik_solver.compute_w_from_tip(affine_gripper_wrt_base,z_vec4,alt_O4);
   ...
   cout<<"WRIST X AXIS: "<<affine_wrist_wrt_base.linear().col(0).transpose()<<endl;
