...
public:
  ...
  ImageSyncher(ros::NodeHandle &nh):nh_(nh),it_(nh_),
    camera_sub_left_(it_.subscribeCamera("davinci_endo/unsynced/left/image_raw", 1,&ImageSyncher::imageLeftCb, this)),
    camera_sub_right_(it_.subscribeCamera("davinci_endo/unsynced/right/image_raw", 1,&ImageSyncher::imageRightCb, this)),
